...
void	ft_pb(t_dlst *a, t_dlst *b, int *ops)
{
	ft_push(a, b);
	ft_printf("pb\n");
	(*ops)++;
...
void	ft_pa(t_dlst *a, t_dlst *b, int *ops)
{
	ft_push(b, a);
	ft_printf("pa\n");
	(*ops)++;
