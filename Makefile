...
#    Updated: 2022/06/14 13:56:17 by hoomen           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME			= push_swap
# source files
MAIN			= print_dlst push_swap input_utils dlst_basics1 dlst_basics2 operations1 operations2 check_dupl sort sort_utils push_sort calc_o calc_d calc_d_min calc_d_max ins_dst
